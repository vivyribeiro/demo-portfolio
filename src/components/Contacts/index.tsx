						...
						<ContactSectionText>
							<Text type="heading2" color="grey4">
								...
								<Text as="span" type="heading2" color="brand1">
									desenvolver soluções incrivéis para sua empresa
								</Text>
								, juntos!
							</Text>
						</ContactSectionText>
					...
					<ContactsCards>
						<ContactCard>
							...
							<ContactCardContent>
								...
								<Text color="grey2" type="body2">
									Quer saber mais informações sobre mim ou meus serviços? Me
									manda uma mensagem
								</Text>
								<Text
									as="a"
						...
						<ContactCard>
							...
							<ContactCardContent>
								...
								<Text color="grey2" type="body2">
									Vem participar da minha rede e compartilhar network
								</Text>
								<Text
									as="a"
									color="grey2"
